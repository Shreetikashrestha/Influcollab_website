...
export default async function BrandDashboard() {
    ...
    const myCampaigns = campaignsRes?.data || [];
    ...
    const stats = [
        { name: "Active Campaigns", value: activeCampaigns, icon: "megaphone", trend: "+2 this month" },
        { name: "Total Applicants", value: totalApplicants, icon: "users", trend: "+12 this week" },
        { name: "Budget Allocated", value: "$16K", icon: "eye", trend: "67% of total" }, // Placeholder for now
        { name: "Total Views", value: "254", icon: "eye", trend: "+45 today" }, // Placeholder for now
    ];
