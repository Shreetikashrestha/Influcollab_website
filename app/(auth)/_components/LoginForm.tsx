...
export default function LoginForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // navigate to dashboard with chosen user type
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-6">
      ...
      <div className="space-y-3 mb-4">
        <button className="w-full flex items-center justify-center gap-3 px-4 py-2 border rounded hover:bg-gray-50">
        ...
        <div className="flex gap-2">
          <button className="flex-1 px-4 py-2 border rounded hover:bg-gray-50">Instagram</button>
          <button className="flex-1 px-4 py-2 border rounded hover:bg-gray-50">Facebook</button>
        </div>
      </div>
