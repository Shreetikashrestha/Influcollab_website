...
export default function Sidebar() {
    ...
    const influencerLinks = [
        ...
        { name: "Discover", href: "/influencer/discover", icon: Search },
        { name: "Messages", href: "/influencer/messages", icon: MessageSquare, badge: 5 },
    ...
    return (
        ...
        >
            ...
            {/* Admin Shortcut (Visible only to admins on user/brand pages) */}
            {user?.role === 'admin' && (
                <div className="px-4 mb-4">
                    <Link
                        href="/admin"
                        className="flex items-center justify-center gap-2 w-full bg-indigo-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-indigo-100 transition-all hover:bg-indigo-700 active:scale-[0.98]"
                    >
